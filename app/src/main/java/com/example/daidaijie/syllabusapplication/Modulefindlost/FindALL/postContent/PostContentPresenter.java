...
public class PostContentPresenter implements PostContentContract.presenter {
    ...
    @Override
    public void postContent(final int kind, final String title, final String desc, final String local, final String contact) {
        ...
        mIPostContentModel.postPhotoToBmob(new IPostContentModel.OnPostPhotoCallBack() {
            ...
            public void onSuccess(String photoJson) {
                mIPostContentModel.pushContent(photoJson,kind,title,desc,local,contact)
