...
import com.example.daidaijie.syllabusapplication.syllabus.LessonEvaluation.LessonEvalActivity;
...
public class LessonInfoActivity extends BaseActivity implements LessonInfoContract.view {
    ...
    @BindView(R.id.courseEvaluationButton)
    Button mCourseEvaluationButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCourseEvaluationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LessonInfoActivity.this,LessonEvalActivity.class);
    ...
    public void showData(Lesson lesson) {
        ...
        mCourseEvaluationButton.setBackgroundDrawable(shape);
