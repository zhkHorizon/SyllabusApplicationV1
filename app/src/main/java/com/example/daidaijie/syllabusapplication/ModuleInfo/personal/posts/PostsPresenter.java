...
public class PostsPresenter implements PostsContract.presenter, CirclesAdapter.OnLongClickCallBack {
    ...
    @Inject
    @PerFragment
    public PostsPresenter(ISchoolCircleModel ISchoolCircleModel,
    ...
    public void refresh() {
        ...
        mISchoolCircleModel.loadPostFromNet(pageIndex)
    ...
    public void loadData() {
        ...
        mISchoolCircleModel.getPostFromNet(pageIndex)
                .subscribe(new Subscriber<List<PostListBean>>() {
                    @Override
                    public void onCompleted() {
